...
export class CreateSingletonCommand<
  Create,
  Entity extends object,
> implements UseCase<{ userId: string; value: Create }, RepresentationResult> {
  constructor(
    private readonly id: string,
    private readonly service: Pick<
      SingletonService<Create, unknown, Entity>,
      'create'
    >,
  ...
  async execute(input: { userId: string; value: Create }) {
    ...
    return createSingletonResult(this.id, entity, revision, 201, this.clock)
  }
}
