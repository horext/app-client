    ...
    <v-card>
      ...
      <v-card-text>
        <p class="text-body-2 text-center text-medium-emphasis mb-4">
          Para exportar tu horario necesitamos acceso a tu Google Calendar. Se
          te pedirá autorizar los siguientes permisos:
        </p>
        <v-list density="compact" lines="two">
          <v-list-item :prepend-icon="mdiCalendarMultiple">
            <v-list-item-title class="text-body-2 font-weight-medium"
              >Ver tus calendarios</v-list-item-title
            >
            <v-list-item-subtitle class="text-caption"
              >Para mostrarte la lista de calendarios
              disponibles</v-list-item-subtitle
            >
          </v-list-item>
          <v-list-item :prepend-icon="mdiCalendarPlus">
            <v-list-item-title class="text-body-2 font-weight-medium"
              >Crear eventos en tu calendario</v-list-item-title
            >
            <v-list-item-subtitle class="text-caption"
              >Para agregar los cursos de tu horario
              generado</v-list-item-subtitle
            >
          </v-list-item>
          <v-list-item :prepend-icon="mdiCalendarCheck">
            <v-list-item-title class="text-body-2 font-weight-medium"
              >Crear un calendario secundario</v-list-item-title
            >
            <v-list-item-subtitle class="text-caption"
              >Opcional: un calendario "Horext" separado del
              principal</v-list-item-subtitle
            >
          </v-list-item>
        </v-list>
        <p class="text-caption text-medium-emphasis text-center mt-3">
          Horext no almacena tu token de acceso. Puedes revocar el permiso en
