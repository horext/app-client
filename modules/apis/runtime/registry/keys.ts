...
export const CLASS_SESSION_API_KEY: InjectionKey<IClassSessionApi> = Symbol('ClassScheduleApi')
...
export const SPECIALITY_API_KEY: InjectionKey<ISpecialityApi> = Symbol('SpecialityApi')

export const HOURLY_LOAD_API_KEY: InjectionKey<IHourlyLoadApi> = Symbol('HourlyLoadApi')

export const SCHEDULE_SUBJECT_API_KEY: InjectionKey<IScheduleSubjectApi> = Symbol('ScheduleSubjectApi')

export const STUDY_PLAN_API_KEY: InjectionKey<IStudyPlanApi> = Symbol('StudyPlanApi')